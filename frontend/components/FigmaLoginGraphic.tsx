...
export function FigmaLoginGraphic() {
  return (
    <div className="hidden lg:flex w-1/2 flex-col items-start justify-center relative overflow-hidden bg-gradient-to-br from-figma-burgundy-dark to-figma-burgundy p-12">
      ...
      <div className="absolute bottom-[20%] left-[10%] w-[30px] h-[30px] rounded-full bg-figma-lavender-light opacity-10" />
        ...
        <div className="relative flex justify-center items-center w-[300px] h-[300px] mb-8">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="w-24 h-24 bg-[#F2F4F3] rounded-t-full rounded-b-[40px] shadow-sm relative overflow-hidden">
              <div className="absolute top-10 left-3 w-7 h-7 bg-figma-burgundy-dark rounded-full"></div>
              <div className="absolute top-10 right-3 w-7 h-7 bg-figma-burgundy-dark rounded-full"></div>
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-4 h-5 bg-figma-burgundy-dark" style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }}></div>
              {/* Teeth */}
          ...
          {/* Leaves */}
          <div className="absolute -bottom-8 -left-12 w-24 h-32 bg-figma-lavender-medium rounded-t-[100px] rounded-bl-[100px] rounded-br-[10px] transform -rotate-45 z-0" style={{ clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' }}></div>
          <div className="absolute -bottom-8 -right-12 w-24 h-32 bg-figma-lavender-light opacity-30 rounded-t-[100px] rounded-br-[100px] rounded-bl-[10px] transform rotate-45 z-0" style={{ clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' }}></div>
        </div>
